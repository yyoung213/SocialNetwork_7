"""
전략 4: 스킬-스킬 Co-occurrence 히트맵 실행
"""
...
from visualize_bipartite_network import read_2mode_network, strategy4_cooccurrence_heatmap

def main():
    print("="*60)
    print("전략 4: 스킬-스킬 Co-occurrence 히트맵")
    print("="*60)
    ...
    try:
        ...
        print("\n✓ 전략 4 완료!")
        print("출력 파일: cooccurrence_heatmap.png")
