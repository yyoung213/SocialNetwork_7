...
data_bipartite_skill_edges.csv를 기반으로 스킬 간 co-occurrence 네트워크를 구축합니다.
"""
...
def load_skill_edges(csv_file: str = 'data_bipartite_skill_edges.csv'):
    """
...
def main():
    """메인 함수"""
    print("="*60)
    print("Skill-Skill Network Builder")
    print("="*60)
