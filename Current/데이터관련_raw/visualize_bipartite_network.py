...
data_bipartite_skill_2mode.net 파일을 기반으로 다양한 시각화 전략을 구현합니다.
"""
...
def strategy1_basic_bipartite(G, companies, skills, node_id_to_label, 
                              output_file='bipartite_basic.png',
...
def strategy2_degree_based(G, companies, skills, node_id_to_label, output_file='bipartite_degree.png'):
    """
...
def strategy4_cooccurrence_heatmap(G, companies, skills, node_id_to_label, output_file='cooccurrence_heatmap.png'):
    """
...
def strategy7_projection(G, companies, skills, node_id_to_label, output_file='projection_networks.png'):
    """
